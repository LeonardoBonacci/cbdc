...
public class RequestThrottler extends RichMapFunction<Transfer, Tuple2<Transfer, Boolean>> {

	private final Long minRequestDifferenceSec;
  ...
  public void open(Configuration config) {
  	StateTtlConfig ttlConfig = StateTtlConfig
  	    .newBuilder(Time.seconds(minRequestDifferenceSec)) 
